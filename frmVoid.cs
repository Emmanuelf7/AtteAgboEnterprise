...
namespace AttehAgboEnterprise
{
    public partial class frmVoid : Form
    {
        ...
        frmCancelDetails f;
        SqlDataReader dr;
        public frmVoid(frmCancelDetails fm)
        {
            InitializeComponent();
            ...
            try
            {
                if(txtPassword.Text !=String.Empty)
                {
                    ...
                    if (dr.HasRows)
                    {
                        ...
                        MessageBox.Show("Order transaction successfully cancelled!", "Cancelled Order", MessageBoxButtons.OK, MessageBoxIcon.Information);
                       this.Dispose();
                        f.RefresList();
                        f.Dispose();
                    }
